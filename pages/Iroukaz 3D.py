...
projectTitle = 'Iroukaz'
projectIcon = '🎮'

headerText = f'{projectTitle}'
videoLink = 'https://youtu.be/1Jw2Q8efxjc'

client = 'Hanze'
liveLink = ''
tableData = [
    {'Client': 'https://www.hanze.nl/en', 'Team Size': '5', 'Engine': 'Unity', 'Platforms': 'Windows, MacOS, Linux'}
]

infoText = """
Iroukaz is a co-op defence game that focuses on the cooperation between players by the means of combined interactions with traps, towers, and spells.
"""

rolesAndResponsibilitiesText = """ 
**Game Design**
- Concept combat gameplay
- Controls (Keyboard/Mouse & Gamepad)

**Level Design**
- Placed some assets
- Made editor scripts to increase the speed of level designers

**Code**
- Player & enemy characters
- Animations combined with masks
- Enemy hurt animation depending on health level
- Camera
- Ragdoll
- Status effects
- Some UI & AI
...
- Shaders
- Some Particles
- Shattering/fracturing art assets
- High Definition Render Pipeline integration
- Post processing
"""
